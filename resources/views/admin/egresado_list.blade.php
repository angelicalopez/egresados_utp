        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center mx-auto">
                    <p>Aquí puedes ver la lista de egresado, de igual manera puedes activarlos o desactivarlos fácilmente </p>
                    <br/>
                </div>
            </div>
            <hr>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="deleteEgresadoModal">Confirmar acción</h5>
          ...
          <form method="POST" action="{{ route('egresado.delete') }}">
            <div class="modal-body">
                    @csrf
                    {{ method_field('delete') }}
                    <h6 class="text-center orange-color">Está seguro que desea borrar el egresado?</h6>                        
                    <input id="delete_egresado_input" name="egresado_id" type="hidden" value="0">
                    <p class="text-justify">Esta acción es irreversible, se perderán los datos del egresado y no podrá volver a ingresar</p>
            </div>
